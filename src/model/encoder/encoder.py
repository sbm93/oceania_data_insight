...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, pretrained_model, device, max_sequence_length, schema_embedding_size, decoder_hidden_size):
        ...
        transformer_config = config_class.from_pretrained("/Users/shubham.c.sharma/Desktop/sql-project/ValueNet/bert")
        self.tokenizer = tokenizer_class.from_pretrained("/Users/shubham.c.sharma/Desktop/sql-project/ValueNet/bert")
        self.transformer_model = model_class.from_pretrained("/Users/shubham.c.sharma/Desktop/sql-project/ValueNet/bert")
